...
Cash always uses the fee on the thread. Stored `lockedFee` is fallback only. Bromley £400 lump. East Barnet NOT locked (quoted / date-offered Sat 4 Dec 2027, pendingLockFee £275 — Gate:lock skipped). Board cash £1,500 / 7 nights (Bluehouse in).
