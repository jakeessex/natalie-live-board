...
async function check() {
  ...
  if (!html.includes("Board v25")) problems.push("index.html missing 'Board v25'");
  ...
  if (!board.includes('BOARD_VERSION = "v25"')) problems.push("board.js is not v25");
  if (problems.length) {
  ...
  console.log(`UI LOCK ok — index ${size} bytes, Board v25, board.js intact`);
}
