...
async function check() {
  ...
  if (!html.includes("Board v20")) problems.push("index.html missing 'Board v20'");
  ...
  if (!board.includes('BOARD_VERSION = "v20"')) problems.push("board.js is not v20");
  if (problems.length) {
  ...
  console.log(`UI LOCK ok — index ${size} bytes, Board v20, board.js intact`);
}
